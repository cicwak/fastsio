...
class TestBaseMiddleware:
    ...
    async def test_handle_exception_default(self):
        ...
        with pytest.raises(Exception, match="test error"):
            await middleware.handle_exception(
                exc, "test_event", "test_sid", "test_data"
            )
...
class TestSyncMiddleware:
    ...
    def test_call_sync_implementation(self):
        ...
        result = middleware.__call__("test_event", "test_sid", "test_data", handler)
...
class TestMiddlewareChain:
    ...
    async def test_execute_no_middlewares(self):
        ...
        result = await chain.execute("test_event", "test_sid", "test_data", handler)
    ...
    async def test_execute_middleware_filtering(self):
        ...
        result = await chain.execute("event2", "test_sid", "test_data", handler)
        ...
        result = await chain.execute("event1", "test_sid", "test_data", handler)
...
class TestMiddlewareIntegration:
    ...
    async def test_middleware_with_async_handler(self):
        ...
        # Test middleware execution
        result = await server._trigger_event(
            "test_event", "/", "test_sid", {"test": "data"}
        )
